(custom-set-variables
 ...
 '(magit-repository-directories
   '(("~/Projects" . 1)
     ("~/Projects/iac" . 1)
     ("~/Projects/puppet" . 1)) nil nil "Customized with use-package magit")
 '(magit-wip-mode t)
