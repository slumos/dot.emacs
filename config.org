# -*- mode: org; -*-
# Time-stamp: <2023-04-06 Thu 08:48 slumos@m2>
      ...
      (use-package modus-themes
        ...
        (defun slumos-modus-themes-custom-faces ()
          (modus-themes-with-colors
            (set-face-attribute 'org-ellipsis nil :foreground comment :height 0.6)))
...
* Org                                                                   :org:
#+begin_src emacs-lisp
  (setq *slumos-org-notes-directory* (expand-file-name "~/Sync/Notes"))
#+end_src
...
* Language Modes
** COMMENT [[https://emacs-tree-sitter.github.io/][Tree Sitter]] - being replaced by built-in
#+begin_src emacs-lisp
...
**** Commonly visited files
     ...
     | c   | ~/.emacs.d/config.org             | main config (config.org) |
     | N   | ~/Sync/OneDrive/Notes/NOTES.org   | NOTES.org                |
     | p   | ~/.emacs.d/personal.org           | personal config          |
     | r   | ~/Sync/Notes/Cookbook.org         | cookbook                 |
     | s   | ~/Sync/Notes/SLUMOS.org           | SLUMOS.org               |
     | t   | ~/Sync/Notes/TODO.org             | TODO.org                 |
