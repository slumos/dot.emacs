...
** Initialization
   ...
   #+RESULTS:
   : #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (23833 32276 914497 0) :init (23833 32276 914314 0) :config (23833 32276 914301 0) :config-secs (0 0 603 0) :init-secs (0 0 632 0) :use-package-secs (0 0 850 0)))
