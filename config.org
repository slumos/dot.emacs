...
** COMMENT Experimental
  ...
  (define-transient-command slumos/magit-open-transient ()
                           "Open related URLs"
                           [["Browse"
                             ("g" "GitHub" slumos/magit-browse-github)
                             ("c" "CircleCI" slumos/magit-browse-github)]])

  (define-key magit-status-mode-map "M-o" #'slumos/magit-open-transient)
#+end_src
** Initialization
* Org                                                                   :org:
#+begin_src emacs-lisp
