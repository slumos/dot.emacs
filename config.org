...
**** Spaceline
     ...
     #+END_SRC
**** TODO [[https://github.com/domtronn/spaceline-all-the-icons.el][domtronn/spaceline-all-the-icons.el: A Spaceline Mode Line theme using All The Icons for Emacs]]
* Helpers
** TRYING WS Butler
...
** Config
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package org-id :ensure org-plus-contrib)
     (use-package org-protocol :ensure org-plus-contrib)
     (use-package ob-sh :ensure org-plus-contrib)
     (use-package org
