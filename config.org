# -*- mode: org; -*-
# Time-stamp: <2020-08-07 Fri 13:28 slumos@slumos-ltm>
...
*** COMMENT [[https://github.com/Mulling/mlso-theme][Mulling/mlso-theme: A dark, medium-contrast theme for emacs]]
    #+begin_src emacs-lisp
      (use-package mlso-theme
        :config (load-theme 'mlso t))
    #+end_src
...
*** Structure Templates
    #+begin_src emacs-lisp
      (add-to-list 'org-structure-template-alist
                   '("sj" . "src shell :results output :wrap src"))
    #+end_src
