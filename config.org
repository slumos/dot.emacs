...
**** All The Icons!
     ...
     #+END_SRC
**** TRYING [[https://github.com/seagle0128/doom-modeline][seagle0128/doom-modeline: A minimal and modern mode-line]]
     #+BEGIN_SRC emacs-lisp
     ...
     #+END_SRC
**** SKIP Spaceline
     Seem to be having issues with spaceline-all-the-icons + macOS Mojave. Trying doom-modeline...
     #+BEGIN_SRC emacs-lisp :tangle no
       (use-package spaceline-config
	 :ensure spaceline
	 :config (spaceline-spacemacs-theme))
     #+END_SRC
**** SKIP [[https://github.com/domtronn/spaceline-all-the-icons.el][domtronn/spaceline-all-the-icons.el: A Spaceline Mode Line theme using All The Icons for Emacs]]
     #+BEGIN_SRC emacs-lisp :tangle no
...
** multiple-cursors
   ...
   #+BEGIN_SRC emacs-lisp :noweb-ref mc-binds :tangle no
       :bind
   ...
   #+BEGIN_SRC emacs-lisp :noweb-ref mc-hydra-no
