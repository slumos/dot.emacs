# -*- mode: org; -*-
# Time-stamp: <2021-05-28 Fri 15:02 slumos@stevenlum-ltm>
...
**** Commonly visited files
     ...
     #+begin_src emacs-lisp :var bindings=commonly-visited-files-shortcuts :results value code replace
       (cl-loop for row in bindings
         collect
         (list
          (car row)
          '(find-file (elt 1 row))
