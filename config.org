# -*- mode: org; -*-
# Time-stamp: <2022-03-07 Mon 10:44 slumos@stevenlum-ltm>
      ...
      (let ((headlines (slumos-get-current-subtree-headlines))
        ...
        (cl-loop for headline in headlines do
                 (let* ((value (org-element-property :raw-value headline)))
                   (if (string-match "W-\[0-9\]\+" value) (setq workitem (match-string 0 value)))))
        workitem))
...
** Copy region formatted for various markup systems
   ...
   #+END_SRC
** Jumping
*** COMMENT [[https://github.com/abo-abo/ace-link][abo-abo/ace-link: Quickly follow links in Emacs]]
    #+BEGIN_SRC emacs-lisp
