# -*- mode: org; -*-
# Time-stamp: <2023-12-11 Mon 14:13 slumos@Steven-Lumos-VXXQV3F32R>
...
#+end_src
** [[https://github.com/jdtsmith/indent-bars][jdtsmith/indent-bars: Fast, configurable indentation guide-bars for Emacs]]
#+begin_src emacs-lisp
...
** YAML
   ...
   #+END_SRC
* Helpers
** TRYING [[https://github.com/joaotavora/breadcrumb][joaotavora/breadcrumb: Emacs headerline indication of where you are in a large project]]
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (use-package tree-sitter-fold
    :vc (:fetcher github :repo junyi-hou/tree-sitter-fold))
#+end_src
